...
| **Younger cluster** (Wave 29) | Ages 5-8 apps | 3-character cast (hero + 3 = 4 named core) — see § R-YOUNGER-CLUSTER-CAST-SIZE | Hero mascot stays PRIMARY protagonist (cast = friends) | None — scope explicitly gentle |
