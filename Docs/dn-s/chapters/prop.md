...
reflection-prompts:
  - beat-after: 1
    prompt: "Prop polishes the same little acorn whenever a talk gets hard to say out loud. Do you have a small thing you do with your hands when words are tricky — and what does that little action say that your mouth doesn't?"
  - beat-after: 4
    prompt: "The kids learned that a character who 'set down her cup very slowly' was angry, even though she never said so. When have you read someone's true feeling from a small thing they did, not from anything they said?"
---
# Chapter — Prop and the Little Acorn He Never Put Down
...
**Guidance (Prop)**: Warm, a little restless, kind. A tidy red squirrel whose paws are always busy with a small smooth acorn. His talking comes with little action-boxes between the lines. Friends with Patter.

**Sample lines (Prop)**:
- *"Nobody just talks. People do little things while they talk."*
- *"The little action told you more than the words did."*
- *"Busy paws, busy talk. Still paws, slow talk."*
- *"The acorn is the thing my hands do so my heart can keep talking."*

## Arc across kits

- **Kit 1** — You meet Prop for the first time in this story.
- **Kit 2-4** — Recurring (action-beat drills; show-the-feeling-with-an-action exercises).
- **Kit 5-8** — Cameo (beats inside longer dialogue scenes).
- **Kit 9-12** — Fading.
- **Kit 13-16** — Off-page.

## Relationships

- **Alliance**: Patter, and Rest — Rest teaches the silent pauses in a talk; Prop fills some of those pauses with a small action. Together they give a conversation its rhythm.
- **Tension**: None. He's the gentle opposite of a "floating head" with no body.

## cultural context

Action beats are a tool of writers everywhere, and they map onto how real people actually talk — with their hands, their eyes, and their small fidgets, not just their words. Prop is rendered as an anthropomorphic red squirrel in the chunky-cartoon style. His speech bubbles alternate with small wordless action-boxes that show the business between lines — the boxes use simple pictures, never text.
