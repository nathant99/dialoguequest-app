...
reflection-prompts:
  - beat-after: 1
    prompt: "Spar lights up when two characters want different things — she calls it the spark that makes a talk come alive. Have you ever had a back-and-forth with a friend where you each wanted something different, and felt how that little push actually made the conversation more interesting?"
  - beat-after: 4
    prompt: "Spar is careful to say the push is never about being mean — it's two people who both care. When have you disagreed with someone you like, and found that the disagreement didn't hurt the friendship at all?"
---
# Chapter — Spar and the Two Bubbles That Pushed
...
**Guidance (Spar)**: Quick, bright, warm, and playful — she loves a good back-and-forth and bounces on her toes when a talk gets lively. A bright-eyed pine marten. Her speech bubbles push against the other speaker's. She is never combative — the push is always affectionate. Friends with Patter.

**Sample lines (Spar)**:
- *"He wants to stay. I want to go. So our talk has somewhere to go."*
- *"The moment we both wanted the same thing, the talk went flat."*
- *"The push is never about being mean. It's two characters who both care."*
- *"The push isn't what pulls people apart. It's one of the ways we hold on."*

## Arc across kits

- **Kit 1** — You meet Spar for the first time in this story.
- **Kit 2-4** — Recurring (conflicting-wants drills; tug-of-war dialogue exercises).
- **Kit 5-8** — Cameo (friction in longer scenes).
- **Kit 9-12** — Fading.
- **Kit 13-16** — Off-page.

## Relationships

- **Alliance**: Patter, and Sprig — Sprig is about giving a choice real weight, and Spar is about giving a talk real friction. Both keep a conversation from going limp.
- **Tension**: A friendly, affectionate push with everyone — that's her whole nature.

## cultural context

Conflicting desires are the engine of dialogue in storytelling traditions everywhere, from folk tales to plays to novels. The "push that stays kind" framing is a deliberate anti-shame choice: friction in a conversation is modeled as caring, not fighting. Spar is rendered as an anthropomorphic pine marten in the chunky-cartoon style. Her pushing speech bubbles are wordless shapes that lean against the other speaker's — no text in the art.
