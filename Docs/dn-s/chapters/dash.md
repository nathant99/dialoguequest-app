...
gate-allow-text:
  - "DialogueQuest"
gate-allow-text-pattern: '^[0-9]+$'
reflection-prompts:
  - beat-after: 1
    prompt: "Dash gets so excited he jumps into the end of other people's sentences. Have you ever been so eager or so worried that you cut someone off before they finished — and what was the feeling underneath that made the words rush out?"
  - beat-after: 4
    prompt: "The kids learned that interrupting on the page shows strong feeling — but only if it's used now and then, not constantly. When has someone interrupting you felt exciting, and when has it felt like they just weren't listening?"
---
# Chapter — Dash and the Sentences He Couldn't Wait to Finish

Patter met Dash on a busy afternoon, and he barely got a word in.
...
**Guidance (Dash)**: Zippy, eager, bursting with energy — he leaps into the ends of other people's sentences when he's excited. A vibrating little chipmunk. He's learning to use his interruptions on purpose, and to let people finish when it matters. Friends with Patter.

**Sample lines (Dash)**:
- *"When someone's too excited to wait, they jump in. That mark — the dash — that's me."*
- *"Every dash is a place someone couldn't wait."*
- *"If everybody always interrupts, it's just noise. The dash only works when it's a surprise."*
- *"The interrupting isn't me not listening. It's me caring out loud, too fast to wait."*

## Arc across kits

- **Kit 1** — You meet Dash for the first time in this story.
- **Kit 2-4** — Recurring (interruption drills; the-dash-on-purpose exercises).
- **Kit 5-8** — Cameo (overlap in tense or excited scenes).
- **Kit 9-12** — Fading.
- **Kit 13-16** — Off-page.

## Relationships

- **Alliance**: Patter, and Rest — they're a perfect pair of opposites. Rest is the long pause that lets a talk breathe; Dash is the crash where someone can't wait. A good scene uses both.
- **Tension**: A friendly, energetic clash with Clip, who would happily trim some of his crashes — but he's learning she's usually right.

## cultural context

Interruption and overlapping speech are how real conversations actually sound, and the em-dash is the written tool for showing it. The "care so much the words rush out" framing reframes interrupting away from rudeness toward strong feeling — paired with the discipline of using it sparingly and learning to let others finish. Dash is rendered as an anthropomorphic chipmunk in the chunky-cartoon style. The colliding speech bubbles are wordless shapes that crash and couple — no text in the art.
