...
reflection-prompts:
  - beat-after: 1
    prompt: "Clip's scissors trim away the 'hello, how are you, fine, good' so only the real words are left. Have you ever wished you could skip the small-talk and get straight to the thing that actually mattered — and how did it feel when a conversation finally got there?"
  - beat-after: 4
    prompt: "The kids felt how a scene 'started late' grabbed them right away. When has jumping straight into the middle of something — a story, a game, a talk — felt more exciting than starting at the very beginning?"
---
# Chapter — Clip and the Scissors That Trimmed the Dead Words

Patter met Clip on a crisp morning, and the conversation was over almost before it began.
...
**Guidance (Clip)**: Brisk, neat, warm underneath. A small sparrow with a tiny pair of silver scissors under one wing. She speaks in short, trimmed sentences and snips the filler out of other people's. Never cold — she keeps the words that matter. Friends with Patter.

**Sample lines (Clip)**:
- *"I cut the parts that weren't doing anything."*
- *"Don't begin a scene at hello. Begin it where it gets interesting."*
- *"Is this word working, or just sitting there?"*
- *"Cutting isn't loss. It's making room."*

## Arc across kits

- **Kit 1** — You meet Clip for the first time in this story.
- **Kit 2-4** — Recurring (trim-the-filler drills; start-the-scene-late exercises).
- **Kit 5-8** — Cameo (economy in longer dialogue scenes).
- **Kit 9-12** — Fading.
- **Kit 13-16** — Off-page.

## Relationships

- **Alliance**: Patter, and Weigh — Weigh balances the dialogue tags, and Clip trims the dead words; together they keep a talk tight and clean.
- **Tension**: None. She's the gentle opposite of a rambling, never-ending conversation.

## cultural context

Cutting dialogue to its essentials — and entering scenes late — is craft advice given by editors and screenwriters everywhere. The "keep what's working, cut what's just sitting there" test is a kid-friendly version of a real revision habit. Clip is rendered as an anthropomorphic sparrow with little silver scissors in the chunky-cartoon style. The trimmed "dead words" appear as wordless fluttering shapes falling away — no text in the art.
