---
character: Listener and Speaker
...
*   **Listener:** Calm, measured, and observant. Their dialogue is minimal, often consisting of non-verbal cues ("hmmm") or short, validating statements. Their presence is felt through their stillness and attentiveness. Their voice is gentle and reassuring.
*   **Speaker:** More expressive and initially anxious. Their speech patterns include false starts ("Um," "Well,") and a slightly more emotional tone that softens as they feel more heard. They are earnest and want to be fair, even when upset.

## Arc across kits

*   **Kit 1 (This chapter):** Introduction to the basic turn-taking rhythm in a low-stakes, one-on-one "hard conversation." The focus is on establishing safety and the core roles of speaking-to-be-heard and listening-to-understand.
*   **Kit 2:** Listener and Speaker could apply their skill in a more complex scenario, such as a group conversation where they have to manage multiple speakers and listeners, or a conversation with a character who is not as skilled at dialogue.
*   **Kit 3:** The cohort could tackle a conversation where the stakes are much higher, or where the "unsaid" things are more complicated and require Listener to ask gentle, clarifying questions to help Speaker fully express themselves.

## Relationships

*   **Listener and Speaker:** They are not adversaries but two parts of a single, functional unit. Their relationship is built on a deep foundation of trust, allowing them to enter a "hard conversation" with the assumption of good intent. They depend on each other completely to make the conversation work. Listener trusts Speaker to be honest, and Speaker trusts Listener to be a safe audience for that honesty. They are two halves of the `conversation-turn pair` primitive.
