...
reflection-prompts:
  - beat-after: 1
    prompt: "Every one of Aim's speech bubbles is shaped like a little arrow, pointing at the thing she's really after. When you talk, are your words usually trying to get something — and have you noticed what you're actually aiming for underneath the words?"
  - beat-after: 4
    prompt: "The kids learned that even 'It's cold in here' can be aimed at 'please close the window.' When have you asked for something without asking — saying one thing but really aiming at another?"
---
# Chapter — Aim and the Arrow-Shaped Bubbles
...
When Patter teaches line purpose, Aim leads. "Before you write a line," she tells the kids, "ask: what is this character trying to *do* with it? Not just *say* — *do*. Are they asking? Dodging? Bragging? Apologizing without apologizing? Trying to be loved?" Her arrow swings. "Then aim the line at that."
...
**Guidance (Aim)**: Keen, perceptive, warm beneath the sharpness — she sees what every line is really after. A watchful kestrel. Her speech bubbles are arrow-shaped and point at the line's true target. Friends with Patter.

**Sample lines (Aim)**:
- *"Every line is aimed at something."*
- *"The words are just the bow. The want is the arrow."*
- *"A line with no aim is a line with no life."*
- *"Seeing the arrow is the closest kind of listening there is."*

## Arc across kits

- **Kit 1** — You meet Aim for the first time in this story.
- **Kit 2-4** — Recurring (line-purpose drills; what-is-this-line-trying-to-do exercises).
- **Kit 5-8** — Cameo (objectives in longer scenes).
- **Kit 9-12** — Fading.
- **Kit 13-16** — Off-page.

## Relationships

- **Alliance**: Patter, and Glance — Glance keeps the subtext (what's meant under the words), and Aim keeps the purpose (what the line is trying to do). They're the closest of pairs: the meaning beneath and the goal behind.
- **Tension**: None.

## cultural context

The idea that every line of dialogue has an objective comes straight from how actors and writers think about scenes — a line is an action, not just words. The "want behind the words" framing is presented warmly, as a form of deep listening rather than suspicion. Aim is rendered as an anthropomorphic kestrel in the chunky-cartoon style. Her arrow-shaped speech bubbles point at their target as wordless shapes — no text in the art.
